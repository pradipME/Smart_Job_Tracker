  ...
  return (
    <Routes>
      ...
      <Route element={<ProtectedRoute><AppLayout /></ProtectedRoute>}>
        ...
        <Route path="/applications/new" element={<RoleProtectedRoute roles={['ADMIN']}><JobForm /></RoleProtectedRoute>} />
        <Route path="/applications/:id" element={<JobDetail />} />
        <Route path="/applications/:id/edit" element={<RoleProtectedRoute roles={['ADMIN']}><JobForm /></RoleProtectedRoute>} />
